...
function Navbar({ onSearchClick,onSubscribeClick }) {
  return (
    <StyledNav>
      <SubheadContainer>
        <StyledLink to="/art">
      ...
      <SubheadContainer2>
        <StyledLink  onClick={onSubscribeClick}>
          <SubheaderText>SUBSCRIBE</SubheaderText>
        </StyledLink>
        <StyledLink to="/login">
          <SubheaderText>SIGN IN</SubheaderText>
        </StyledLink>
        <StyledSearchIcon onClick={onSearchClick} size={20} />
      </SubheadContainer2>
    </StyledNav>
  );
}
